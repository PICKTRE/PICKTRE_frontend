    ...
    <>
      ...
      <div className={classes.container}>
        ...
        <div className={classes.item}>
          <img src={trophy} alt="혜택 이미지" className={classes.itemImg1} />
        ...
        {/* 매월 GREEN DAY 혜택 */}
        <div className={classes.item}>
          <img src={gift} alt="혜택 이미지" className={classes.itemImg3} />
        ...
        {/* 생일축하 혜택 */}
        <div className={classes.item}>
          <img src={cake} alt="혜택 이미지" className={classes.itemImg4} />
